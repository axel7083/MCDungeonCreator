...
public class Tile {
    ...
    private final Set<Tile> children = Sets.newLinkedHashSet();
    private final ITextComponent displayText;
    public InGameTile inGameTile;

    public Tile(ResourceLocation id, @Nullable Tile parentIn, @Nullable DisplayInfo displayIn, AdvancementRewards rewardsIn, Map<String, Criterion> criteriaIn, String[][] requirementsIn) {
        this.id = id;
     ...
     */
    public Tile.Builder copy() {
        return new Tile.Builder(this.parent == null ? null : this.parent.getId(), this.display, this.rewards, this.criteria, this.requirements);
    }
     ...
     * @see #getParent()
     */
    public Iterable<Tile> getChildren() {
     ...
     * @see #getParent()
     */
    public void addChild(Tile tileIn) {
        this.children.add(tileIn);
    }
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            return true;
        } else if (!(p_equals_1_ instanceof Tile)) {
            return false;
        } else {
            Tile tile = (Tile)p_equals_1_;
    ...
    public static class Builder {
        ...
        public static Tile.Builder builder() {
            return new Tile.Builder();
        }

        public Tile.Builder withParent(Tile parentIn) {
            this.parent = parentIn;
            return this;
        }

        public Tile.Builder withParentId(ResourceLocation parentIdIn) {
            this.parentId = parentIdIn;
            return this;
        }

        public Tile.Builder withDisplay(ItemStack stack, ITextComponent title, ITextComponent description, @Nullable ResourceLocation background, FrameType frame, boolean showToast, boolean announceToChat, boolean hidden) {
            return this.withDisplay(new DisplayInfo(stack, title, description, background, frame, showToast, announceToChat, hidden));
        }

        public Tile.Builder withDisplay(IItemProvider itemIn, ITextComponent title, ITextComponent description, @Nullable ResourceLocation background, FrameType frame, boolean showToast, boolean announceToChat, boolean hidden) {
        ...
        public Tile.Builder withDisplay(DisplayInfo displayIn) {
            this.display = displayIn;
            return this;
        }

        public Tile.Builder withRewards(AdvancementRewards.Builder rewardsBuilder) {
            return this.withRewards(rewardsBuilder.build());
        }

        public Tile.Builder withRewards(AdvancementRewards rewards) {
         ...
         */
        public Tile.Builder withCriterion(String key, ICriterionInstance criterionIn) {
         ...
         * Adds a criterion to the list of criteria
         */
        public Tile.Builder withCriterion(String key, Criterion criterionIn) {
        ...
        public Tile.Builder withRequirementsStrategy(IRequirementsStrategy strategy) {
         ...
         */
        public boolean resolveParent(Function<ResourceLocation, Tile> lookup) {
        ...
        public Tile build(ResourceLocation id) {
            if (!this.resolveParent((parentID) -> {
                ...
                return new Tile(id, this.parent, this.display, this.rewards, this.criteria, this.requirements);
            }
        }

        public Tile register(Consumer<Tile> consumer, String id) {
            Tile tile = this.build(new ResourceLocation(id));
        ...
        public static Tile.Builder deserialize(JsonObject json, ConditionArrayParser conditionParser) {
            ...
            if (map.isEmpty()) {
                ...
                return new Tile.Builder(resourcelocation, displayinfo, advancementrewards, map, astring);
            }
        }

        public static Tile.Builder readFrom(PacketBuffer buf) {
            ...
            return new Tile.Builder(resourcelocation, displayinfo, AdvancementRewards.EMPTY, map, astring);
        }
