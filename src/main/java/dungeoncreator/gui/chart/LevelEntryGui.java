...
@OnlyIn(Dist.CLIENT)
public class LevelEntryGui extends AbstractGui {
    ...
    private LevelEntryGui parent;
    private final List<LevelEntryGui> children = Lists.newArrayList();
    ...
    private LevelEntryGui getFirstVisibleParent(Tile advancementIn) {
        ...
        return advancementIn != null && advancementIn.getDisplay() != null ? this.guiAdvancementTab.getLevelEntryGui(advancementIn) : null;
    }
    ...
    public void addGuiAdvancement(LevelEntryGui guiAdvancementIn) {
